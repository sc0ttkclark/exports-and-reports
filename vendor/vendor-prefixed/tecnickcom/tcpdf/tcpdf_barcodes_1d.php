...
//               common 1D barcodes to be used with ExportsReports__Prefixed__TCPDF.
//
//============================================================+

/**
 * @file
 * PHP class to creates array representations for common 1D barcodes to be used with ExportsReports__Prefixed__TCPDF.
...
/**
 * @class ExportsReports__Prefixed__TCPDFBarcode
 * PHP class to creates array representations for common 1D barcodes to be used with ExportsReports__Prefixed__TCPDF (http://www.tcpdf.org).<br>
 * @package com.tecnick.tcpdf
 * @version 1.0.027
 * @author Nicola Asuni
 */
