...
// DESCRIPTION :
//
// Class to create DataMatrix ECC 200 barcode arrays for ExportsReports__Prefixed__TCPDF class.
...
/**
* @class ExportsReports__Prefixed__Datamatrix
* Class to create DataMatrix ECC 200 barcode arrays for ExportsReports__Prefixed__TCPDF class.
* DataMatrix (ISO/IEC 16022:2006) is a 2-dimensional bar code.
*
* @package com.tecnick.tcpdf
...
// -----------------------------------------------------------------------------
	 ...
	 * @param string $code Code to represent using ExportsReports__Prefixed__Datamatrix.
	 * @public
	 */
